...
const Purchase: NextPage<IProps> = ({ token }) => {
  ...
  const [getLectureData, { loading, data: lectureData }] = useMutation(
    id ? lecturesApi.detail : null
  );
  const [getMyData, { data: myData }] = useMutation(
    token ? purchaseApi.myData : null
  );
  ...
  const handlePayment = () => {
    ...
    const params = {
      ...
      buyer_email: myData.email, // 이메일
      buyer_name: myData.name, // 이름
      buyer_tel: myData.phone_number.replace(
        /^(\d{2,3})(\d{3,4})(\d{4})$/,
        `$1-$2-$3`
      ), // 전화번호
    };
              ...
              <div className='divide-y-2 divide-[#4a4e57]'>
                ...
                <div className='flex items-start pt-6 pb-8'>
                  ...
                  <div className='grow'>
                    ...
                    <div className='pt-8'>
                      <div className='text-lg text-[#00e7ff]'>
                        {coupon.name}
                      </div>
                ...
                <div className='flex items-start py-8'>
                  ...
                  <div className='space-y-6'>
                    <div className='text-lg'>
                      총 <span className='font-bold'>{myData.point}P</span> 보유
                    </div>
