  ...
  const pointList = [
    {
      ...
      pointNum: "01",
      title:
        "혼자 읽기 어려운 경제 필독서를<br />현업 경제전문가와 함께 스터디 진행",
      content:
        "노현우 경제전문가와 함께 읽고 공부하면서<br />실전에서 쓰이는 경제 지식을 투자에 활용할 수 있도록 학습합니다.",
    },
    {
      id: 1,
      pointNum: "02",
      title:
        "단순하게 읽고 끝내는 독서가 아닌<br />자기것으로 소화할 수 있게 스터디 진행",
      content:
        "읽고 끝낸다면 내것이 될 수 없습니다.<br />커뮤니티 구성원들과 챌린지를 진행하면서 내 것이 될 수 있도록 해야합니다.",
    },
    {
      id: 3,
      pointNum: "03",
      title:
        "지적수준이 높은 스터디모임과<br />함께 토론하고 소통하며 스터디 진행",
      content:
        "구성원의 지적수준이 매우 높을 뿐더러<br />같이 책을 읽고 글을쓰며 서로에게 피드백을 주는 양방향적인 질높은 독서모임을 제공합니다.",
    },
  ];
  ...
  return (
    <div className="bg-black pt-[6.25rem] pb-[7.5rem]">
      <div className="mx-auto w-full max-w-[1528px] text-center">
        ...
        {pointList.map((point) => (
          <div className="mt-[6.25rem] flex justify-center space-x-10">
            <div className="h-[33.5rem] w-[40.938rem] rounded-[20px] bg-slate-500" />
            <div className="w-[52.063rem] rounded-[20px] bg-[#4a4e57] px-20 py-[6.25rem] text-left text-white">
